...
INSERT OR REPLACE INTO trip_templates (
  ...
  '["travelers_adults", "travelers_children", "traveler_ages", "luxury_level", "activity_level", "departure_date", "home_country", "transportation_preference", "driving_comfort", "ai_model", "max_firecrawl_urls", "use_ai_confirmation"]',  -- optional_fields (JSON)
