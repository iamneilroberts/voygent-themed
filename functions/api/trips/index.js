...
export async function onRequestPost(context) {
    ...
    try {
        ...
        if (!body.template_id || !body.initial_message) {
            return new Response(JSON.stringify({ error: 'Missing required fields: template_id and initial_message' }), {
                status: 400,
        ...
        const trip = await db.createTrip(tripId, body.template_id, body.initial_message, body.preferences);
        ...
        context.waitUntil(researchService.researchDestinations({
            tripId,
