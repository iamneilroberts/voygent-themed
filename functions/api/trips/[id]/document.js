...
export async function onRequestGet(context) {
    ...
    try {
        ...
        const html = generateTravelDocument(tripId, templateName, destinations, selectedOption, preferences);
        // Log telemetry
 ...
 */
function generateTravelDocument(tripId, tripType, destinations, option, preferences) {
...
function generateFlightsSection(option) {
    if (!option.flights)
        return '';
...
function generateHotelsSection(hotels) {
...
function generateToursSection(tours) {
...
function generateItinerarySection(dailyItinerary) {
    ...
    <div class="day-card">
      <div class="day-header">
        <span class="day-number">Day ${day.day_number}${day.date ? ` - ${formatDateDisplay(day.date)}` : ''}</span>
        <span class="day-location">📍 ${escapeHtml(day.city)}</span>
      </div>
...
function generateCostSummary(option, hotels, tours) {
