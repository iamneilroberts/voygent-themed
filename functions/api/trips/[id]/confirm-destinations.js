...
export async function onRequestPost(context) {
    ...
    try {
        ...
        const invalidDestinations = body.confirmed_destinations.filter(dest => !researchDestinationNames.includes(dest.toLowerCase()));
        ...
        const finalPreferences = body.preferences
