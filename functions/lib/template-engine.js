...
export class TemplateEngine {
     ...
     */
    extractContext(userMessage, preferences, template) {
        const context = {};
     ...
     */
    buildResearchQueries(template, context) {
     ...
     */
    buildDestinationCriteria(template, context) {
     ...
     */
    buildResearchSynthesis(template, context) {
     ...
     */
    buildDestinationConfirmation(template, context) {
     ...
     */
    buildOptionsPrompt(template, context) {
     ...
     */
    buildDailyActivityPrompt(template, context) {
