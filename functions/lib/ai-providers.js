...
export class AIProviderManager {
     ...
     */
    async generate(request, costTracker) {
        const errors = [];
        for (const provider of this.providers) {
            ...
            try {
                ...
                if (costTracker) {
                    await costTracker.trackAICost(provider.name, provider.model, response.inputTokens, response.outputTokens, provider.costPer1kInputTokens, provider.costPer1kOutputTokens);
                }
